...
namespace XafSecureDash.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafSecureDashModule : ModuleBase
    {
        public XafSecureDashModule()
        {
            //
            // XafSecureDashModule
            //
            AdditionalExportedTypes.Add(typeof(XafSecureDash.Module.BusinessObjects.ApplicationUser));
