...
using System.Text;
using XafSecureDash.WebApi.JWT;

namespace XafSecureDash.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXafWebApi(builder =>
            {
                ...
                builder.Modules
                    ...
                    .AddValidation()
                    .Add<XafSecureDash.Module.XafSecureDashModule>();
                ...
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        ...
                        .WithDbContext<XafSecureDash.Module.BusinessObjects.XafSecureDashEFCoreDbContext>((serviceProvider, options) =>
                        {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(XafSecureDash.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(XafSecureDash.Module.BusinessObjects.ApplicationUserLoginInfo);
                ...
                {
                    application.ApplicationName = "SetupApplication.XafSecureDash";
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "XafSecureDash API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafSecureDash.WebApi\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafSecureDash WebApi v1");
                });
            }
            else
            {
