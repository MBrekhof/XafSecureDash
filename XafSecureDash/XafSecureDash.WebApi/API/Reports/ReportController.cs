...
namespace XafSecureDash.WebApi.Reports
{
    [Authorize]
    ...
    public class ReportController : ControllerBase
    {
        ...
        void ApplyParametersFromQuery(XtraReport report)
        {
        ...
        SortProperty[]? LoadSortPropertiesFromQuery()
        {
        ...
        async Task<object> GetReportContentAsync(XtraReport report, ExportTarget fileType)
        {
