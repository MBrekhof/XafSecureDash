...
namespace XafSecureDash.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<XafSecureDashWindowsFormsApplication>();
            builder.Modules
                .AddCharts()
                ...
                .Add<XafSecureDashWinModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options =>
                {
                    options.PreFetchReferenceProperties();
                })
                    .WithDbContext<XafSecureDash.Module.BusinessObjects.XafSecureDashEFCoreDbContext>((application, options) =>
                    {
